...
ImSeq = zeros(VIDEO_HEIGHT, VIDEO_WIDTH, 3, NumImages);
for i=1:NumImages
...
Video = ImSeq ./255;
[Video_Height,Video_Width,cdepth,NumFrames] = size(Video);

disp(' SAVING DATA');


save("head.mat", 'Video','ROI_Center','ROI_Width','ROI_Height',...
